...
| <img src="{{site.url}}/images/cpad/img4_nativeAppsGen.png"/> |
| :------------------------------------------------: |
...
| <img src="{{site.url}}/images/cpad/img2_advantages.png" height="400" /> |
| :----------------------------------------------------------: |
|                     *Advantages of CPAD*                     |
...
- Examples:
  ...
  - **Flutter**: Open-source UI kit developed by Google. It integrates easily with Android Studio and Visual Studio. The logic is written in Dart, the UI is written in Flutter Widgets. It can be deployed very quickly, dart is also a declarative language which helps developers focus on writing code quickly.  
    ...
    | <img src="{{site.url}}/images/cpad/img3_FlutterGen.png"  height=300 style="margin-bottom: 20px;"/> |
    | :----------------------------------------------------------: |
    |                    *Flutter Architecure*                     |
...
| <img src="{{site.url}}/images/cpad/img6_hybridGen.png" height=250/> |
| :-------------------------------------------------------: |
...
| <img src="{{site.url}}/images/cpad/img10_ReactNativeGen.png" height=300/> |
| :----------------------------------------------------------: |
...
| <img src = "{{site.url}}/images/maui_intro/maui_cpad.png" height=300/> |
| :----------------------------------------------------------: |
