...
* **Worth**: 3%
* 📅 **Due**: February 23, 2024 @ end-of-class.
...
* 📥**Submission**: Check-in in class and final submit through GitHub classroom.

## Objective

- Use XAML Binding 
- Use View to Code Behind Binding
- Learn how to seperate the business logic from the Views
